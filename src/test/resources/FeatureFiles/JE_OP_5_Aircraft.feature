Feature: AIRCRAFT DETAILS
  ...
  Scenario: Aircraft Check
    Given To Check Aircraft User is navigating to JetEdge URL is "http://192.168.1.33/OWNERV2/login.aspx"
    When To Check Aircraft User Enter Valid username and Valid password are "soundharya@sankarasoftware.com" and "Soundharya@123"
