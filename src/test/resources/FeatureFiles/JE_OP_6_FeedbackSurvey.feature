Feature: FEEDBACK SURVEY
  ...
  Scenario: Feedback Survey Check
    Given To Check Feedback Survey User is navigating to JetEdge URL is "http://192.168.1.33/OWNERV2/login.aspx"
    When To Check Feedback Survey User Enter Valid username and Valid password are "soundharya@sankarasoftware.com" and "Soundharya@123"
